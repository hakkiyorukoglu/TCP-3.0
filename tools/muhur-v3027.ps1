...
$out = Join-Path ([Environment]::GetFolderPath("Desktop")) "RAPOR_MUHUR_v3027.txt"
"=== v3.0.27 MUHUR RAPORU (SwitchTool) - $($(Get-Date -Format 'yyyy-MM-dd HH:mm')) ===" | Out-File $out -Encoding utf8
function B($t,$s){ "
...
B "3. BEKCI ISPATI: T010 kapsam (134, YESIL beklenir)" {

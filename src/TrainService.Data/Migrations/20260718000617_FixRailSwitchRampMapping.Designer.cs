...
namespace TrainService.Data.Migrations
{
    ...
    [Migration("20260718000617_FixRailSwitchRampMapping")]
    partial class FixRailSwitchRampMapping
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TrainService.Core.Entities.RailSwitch", b =>
                {
                    ...
                    b.Property<string>("BoundServoDeviceId")
                        .HasColumnType("TEXT");

                    b.Property<string>("DivergingExitNodeId")
                        .IsRequired()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("MainExitNodeId")
                        .IsRequired()
                        .HasColumnType("TEXT");
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Position", "TrainService.Core.Entities.RailSwitch.Position#Vector2D", b1 =>
                        {
            ...
            modelBuilder.Entity("TrainService.Core.Entities.Ramp", b =>
                {
                    ...
                    b.ComplexProperty<Dictionary<string, object>>("Position", "TrainService.Core.Entities.Ramp.Position#Vector2D", b1 =>
                        {
                            b1.Property<double>("X")
                                .HasColumnType("REAL");
            ...
            modelBuilder.Entity("TrainService.Core.Entities.Station", b =>
                {
                    ...
                    b.Property<string>("EntrySwitchId")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("TrainService.Core.Entities.SwitchPort", b =>
                {
                    ...
                    b.Property<string>("CascadeSwitchId")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<string>("NetworkSwitchId")
                        .IsRequired()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("TrainService.Core.Entities.Layer", b =>
                {
                    b.HasOne("TrainService.Core.Entities.Project", null)
                        .WithMany()
